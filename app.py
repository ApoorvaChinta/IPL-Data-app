...
app.layout = html.Div([
    ...
    dbc.Row([
        dbc.Col([
            (html.H3("The Best Winning Teams",className="text-center")),
            dcc.Graph(id="box", figure=fig_bestteam)

        ]),

        dbc.Col([
            (html.H1("Top Ten Players",className='text-center')),
    ...
    dbc.Row([
        dbc.Col([
             (html.H1("Luckiest Venues for Teams",className='text-center')),
        ...
        dbc.Col([
            (html.H3("Matches win by Runs",className='text-center')),
